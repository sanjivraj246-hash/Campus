  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-[11px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        purple: "border-transparent bg-purple-500/15 text-purple-300 border-purple-500/30",
        cyan: "border-transparent bg-cyan-500/15 text-cyan-300 border-cyan-500/30",
      },
    },
    defaultVariants: {
      variant: "default",
